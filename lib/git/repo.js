...
function Repo(repo_config) {
  ...
  Object.defineProperty(this, 'regex_tags', {
    // if undefined, use a greedy regex to match all tags
    value: repo_config['regex_tags'] == undefined ? ".*": repo_config['regex_tags']
  });
...
Repo.prototype.createNewTagsAsBranch = function(cb) {
  var this_obj = this;
  git_commands.extractTags(this_obj.regex_tags, this_obj.url, this_obj.repo_config.local_store, function (err, tags) {
    /* istanbul ignore if */
